...
const pt: Dict = {
  ...
  'update.available': 'Nova versão disponível: v',
  'about.title': 'Sobre',
  'about.tagline': 'Um navegador de clusters Kubernetes — app desktop, UI web e servidor MCP, tudo no mesmo binário.',
  'about.devBuild': 'build de desenvolvimento',
  'about.upToDate': 'Você está na versão mais recente',
  'about.configFile': 'Arquivo de configuração',
  'about.viewOnGithub': 'Ver no GitHub',
  'kubeconfig.title': 'Gerenciar kubeconfig',
  'kubeconfig.contexts': 'Contextos',
  'kubeconfig.cluster': 'Cluster',
  'kubeconfig.user': 'Usuário',
  'kubeconfig.read': 'leitura',
  'kubeconfig.write': 'escrita',
  'kubeconfig.favorite': 'Favoritar',
  'kubeconfig.unfavorite': 'Remover dos favoritos',
  'kubeconfig.pinging': 'Testando…',
  'kubeconfig.testConnection': 'Testar conexão',
  'kubeconfig.setCurrent': 'Definir como contexto atual',
  'kubeconfig.newContext': 'Novo contexto a partir de cluster + usuário existentes',
  'kubeconfig.create': 'Criar',
  'kubeconfig.users': 'Usuários',
  'kubeconfig.newUser': 'Novo usuário',
  'kubeconfig.authMethod': 'Autenticação',
  'kubeconfig.usernamePassword': 'Usuário / senha',
  'kubeconfig.clientCertKey': 'Certificado / chave do cliente',
  'kubeconfig.username': 'Nome de usuário',
  'kubeconfig.token': 'Token',
  'kubeconfig.password': 'Senha',
  'kubeconfig.clientKey': 'Chave do cliente',
  'kubeconfig.clientCert': 'Certificado do cliente',
  'kubeconfig.revealFailed': 'falha ao carregar',
  'kubeconfig.importAnother': 'Importar outro kubeconfig',
  'kubeconfig.import': 'Importar kubeconfig',
  'kubeconfig.pasteYaml': 'Cole um kubeconfig em YAML aqui',
  'kubeconfig.preview': 'Pré-visualizar',
  'kubeconfig.willAdd': 'Será adicionado',
  'kubeconfig.conflicts': 'conflitos',
  'kubeconfig.selectOverwrite': 'Selecione os nomes a sobrescrever (os não marcados serão ignorados):',
  'kubeconfig.commitImport': 'Confirmar mesclagem',
  ...
  'group.customResources': 'Recursos Personalizados',
  'controls.metrics': 'Métricas',
  'controls.background': 'Fundo animado',
  'controls.mcp': 'Servidor MCP',
  'controls.mcpAllowWrite': 'Permitir escrita',
  'controls.mcpToken': 'Token de acesso',
  'controls.mcpRegenerateToken': 'Gerar novo token',
...
const en: Dict = {
  ...
  'about.title': 'About',
  'about.tagline': 'A Kubernetes cluster navigator — desktop app, web UI, and MCP server, all the same binary.',
  ...
  'kubeconfig.title': 'Manage kubeconfig',
  'kubeconfig.contexts': 'Contexts',
  'kubeconfig.cluster': 'Cluster',
  'kubeconfig.user': 'User',
  'kubeconfig.read': 'read',
  'kubeconfig.write': 'write',
  'kubeconfig.favorite': 'Favorite',
  'kubeconfig.unfavorite': 'Remove favorite',
  'kubeconfig.pinging': 'Testing…',
  'kubeconfig.testConnection': 'Test connection',
  'kubeconfig.setCurrent': 'Set as current context',
  'kubeconfig.newContext': 'New context from existing cluster + user',
  'kubeconfig.create': 'Create',
  'kubeconfig.users': 'Users',
  'kubeconfig.token': 'Token',
  'kubeconfig.password': 'Password',
  'kubeconfig.clientKey': 'Client key',
  'kubeconfig.clientCert': 'Client cert',
  'kubeconfig.revealFailed': 'failed to load',
  'kubeconfig.importAnother': 'Import another kubeconfig',
  'kubeconfig.import': 'Import kubeconfig',
  'kubeconfig.pasteYaml': 'Paste a kubeconfig YAML here',
  'kubeconfig.preview': 'Preview',
  'kubeconfig.willAdd': 'Will add',
  'kubeconfig.conflicts': 'conflicts',
  'kubeconfig.selectOverwrite': 'Select names to overwrite (unchecked entries are skipped):',
  'kubeconfig.commitImport': 'Commit merge',
  'group.workloads': 'Workloads',
  'group.rede': 'Network',
  'group.config': 'Config',
  ...
  'group.cluster': 'Cluster',
  'group.customResources': 'Custom Resources',
  'controls.metrics': 'Metrics',
  'controls.background': 'Animated background',
  'controls.mcp': 'MCP server',
  'controls.mcpAllowWrite': 'Allow write',
  'controls.mcpToken': 'Access token',
  'controls.mcpRegenerateToken': 'Generate new token',
